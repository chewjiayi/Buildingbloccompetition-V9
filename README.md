...
- Web speech recogisation (https://developer.mozilla.org/en-US/docs/Web/API/SpeechRecognition)

- Chart.js (https://youtu.be/sE08f4iuOhA)

- Local Storage API (https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage)

- setTimeout API (Async Behaviour)  
